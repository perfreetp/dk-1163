...
export const api = {
  ...
  requirements: {
    ...
    update: (versionId: string, id: string, data: any) => fetchAPI<any>(`/versions/${versionId}/requirements/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
    delete: (versionId: string, id: string) => fetchAPI<{ success: boolean }>(`/versions/${versionId}/requirements/${id}`, { method: 'DELETE' }),
  },
  screenshots: {
    ...
    delete: (versionId: string, id: string) => fetchAPI<{ success: boolean }>(`/versions/${versionId}/screenshots/${id}`, { method: 'DELETE' }),
  },
  trackingPoints: {
    ...
    update: (versionId: string, id: string, data: any) => fetchAPI<any>(`/versions/${versionId}/tracking-points/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
    delete: (versionId: string, id: string) => fetchAPI<{ success: boolean }>(`/versions/${versionId}/tracking-points/${id}`, { method: 'DELETE' }),
  },
  acceptanceCriteria: {
    ...
    updateStatus: (versionId: string, id: string, status: string) => fetchAPI<any>(`/versions/${versionId}/acceptance-criteria/${id}/status`, { method: 'PUT', body: JSON.stringify({ status }) }),
    delete: (versionId: string, id: string) => fetchAPI<{ success: boolean }>(`/versions/${versionId}/acceptance-criteria/${id}`, { method: 'DELETE' }),
  },
  reviews: {
